...
/**
 * InvalidFeeValue: 'You are setting a higher fee value'
 *
 * @category Errors
 * @category generated
 */
export class InvalidFeeValueError extends Error {
  readonly code: number = 0x1773
  readonly name: string = 'InvalidFeeValue'
  constructor() {
    super('You are setting a higher fee value')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, InvalidFeeValueError)
    }
  }
}

createErrorFromCodeLookup.set(0x1773, () => new InvalidFeeValueError())
createErrorFromNameLookup.set(
  'InvalidFeeValue',
  () => new InvalidFeeValueError()
)

/**
 * InvalidFeeReductionValue: 'You are setting a higher fee reduction value'
 *
 * @category Errors
 * @category generated
 */
export class InvalidFeeReductionValueError extends Error {
  readonly code: number = 0x1774
  readonly name: string = 'InvalidFeeReductionValue'
  constructor() {
    super('You are setting a higher fee reduction value')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, InvalidFeeReductionValueError)
    }
  }
}

createErrorFromCodeLookup.set(0x1774, () => new InvalidFeeReductionValueError())
createErrorFromNameLookup.set(
  'InvalidFeeReductionValue',
  () => new InvalidFeeReductionValueError()
)

/**
 * InvalidRewardValue: 'You are setting a higher reward value'
 *
 * @category Errors
 * @category generated
 */
export class InvalidRewardValueError extends Error {
  readonly code: number = 0x1775
  readonly name: string = 'InvalidRewardValue'
  constructor() {
    super('You are setting a higher reward value')
    if (typeof Error.captureStackTrace === 'function') {
      Error.captureStackTrace(this, InvalidRewardValueError)
    }
  }
}

createErrorFromCodeLookup.set(0x1775, () => new InvalidRewardValueError())
createErrorFromNameLookup.set(
  'InvalidRewardValue',
  () => new InvalidRewardValueError()
)
...
createErrorFromCodeLookup.set(0x1776, () => new InconrrectAppAccountError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1777, () => new InconrrectCreatorAccountError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1778, () => new IncorrectPaymentMintError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1779, () => new IncorrectATAError())
...
createErrorFromCodeLookup.set(0x177a, () => new IncorrectAuthorityError())
createErrorFromNameLookup.set(
  'IncorrectAuthority',
...
createErrorFromCodeLookup.set(0x177b, () => new IncorrectMintError())
...
createErrorFromCodeLookup.set(0x177c, () => new IncorrectNonceError())
...
createErrorFromCodeLookup.set(0x177d, () => new IncorrectSeedsError())
...
createErrorFromCodeLookup.set(0x177e, () => new IncorrectGovernanceNameError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x177f, () => new IncorrectTokenProgramError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1780, () => new IncorrectInstructionError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1781, () => new ConversionErrorError())
createErrorFromNameLookup.set(
  'ConversionError',
...
createErrorFromCodeLookup.set(0x1782, () => new TransferErrorError())
...
createErrorFromCodeLookup.set(0x1783, () => new MintToErrorError())
...
createErrorFromCodeLookup.set(0x1784, () => new BurnErrorError())
...
createErrorFromCodeLookup.set(0x1785, () => new CloseAccountErrorError())
createErrorFromNameLookup.set(
  'CloseAccountError',
...
createErrorFromCodeLookup.set(0x1786, () => new ClosedPromotionError())
createErrorFromNameLookup.set(
  'ClosedPromotion',
...
createErrorFromCodeLookup.set(0x1787, () => new OpenPromotionError())
...
createErrorFromCodeLookup.set(0x1788, () => new ExtensionNotSupportedError())
createErrorFromNameLookup.set(
...
createErrorFromCodeLookup.set(0x1789, () => new CreateAccountErrorError())
createErrorFromNameLookup.set(
  'CreateAccountError',
...
createErrorFromCodeLookup.set(0x178a, () => new MintExtensionErrorError())
createErrorFromNameLookup.set(
  'MintExtensionError',
...
createErrorFromCodeLookup.set(0x178b, () => new InitMintErrorError())
...
/**
 * NotAllowed: 'You dont have the token that allows you to create products'
 *
 * @category Errors
 * @category generated
 */
...
createErrorFromCodeLookup.set(0x178d, () => new NotAllowedError())
